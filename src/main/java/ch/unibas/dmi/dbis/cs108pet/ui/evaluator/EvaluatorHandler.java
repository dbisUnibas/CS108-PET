...
import ch.unibas.dmi.dbis.cs108pet.common.Callback;
...
import ch.unibas.dmi.dbis.cs108pet.storage.CS108PETFile;
import ch.unibas.dmi.dbis.cs108pet.storage.UuidMismatchException;
import ch.unibas.dmi.dbis.cs108pet.ui.StatusBar;
import ch.unibas.dmi.dbis.cs108pet.ui.common.FilterActionHandler;
...
public class EvaluatorHandler implements EventHandler<CUDEvent>, FilterActionHandler {
  ...
  public void handleOpenGroups(ActionEvent actionEvent) {
    ...
    fc.getExtensionFilters().add(CS108PETFile.Type.GROUP.getExtensionFilter());
    ...
    if (files == null) {
      ...
      try {
        ...
        Utils.showErrorDialog("Corrupt group file", "The group file of group (" + e.getEntity().getName() + ") is corrupt.\n" +
            ...
            "Please restart cs108pet to avoid further corrupt files.");
      }
