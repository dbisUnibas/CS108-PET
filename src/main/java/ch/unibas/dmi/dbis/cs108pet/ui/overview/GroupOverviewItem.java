 ...
 * ch.unibas.dmi.dbis.cs108pet.data.Group}s.
 * <p>
 ...
 * <ul>
 * <li>
 * The name represents a {@link ch.unibas.dmi.dbis.cs108pet.data.Catalogue}.
 * In this case the id-points pairs are a tuples of a
 * {@link ch.unibas.dmi.dbis.cs108pet.data.Group}'s {@link java.util.UUID} and the sum of this group,
 * as calculated by {@link GroupAnalyser#getSum()}
 * </li>
 * <li>
 * The name reprsents a {@link ch.unibas.dmi.dbis.cs108pet.data.Milestone}.
 * In this case, the id-points pair are a tuples of a
 * {@link ch.unibas.dmi.dbis.cs108pet.data.Group}'s {@link java.util.UUID} and the sum of this group,
 * for this milestone's {@link ch.unibas.dmi.dbis.cs108pet.data.ProgressSummary} as calculated by
