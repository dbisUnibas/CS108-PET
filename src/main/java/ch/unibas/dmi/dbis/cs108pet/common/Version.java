...
/**
 * The {@link Version} singleton is used to inform the application cs108pet about its own
...
public class Version implements Comparable<Version> {
  ...
  private static final String PROPERTIES_FILE = "cs108pet.properties";
  
  private static final String APP_KEY = "cs108pet";
  
  private static final String VERSION_KEY = APP_KEY + "." + "version";
  ...
  private Version() {
    ...
    try {
      ...
      LOGGER.error("Could not load cs108pet.properties.", e);
      handleInvalidVersion();
    }
  }
  ...
  /**
   * Returns the full version String. This matches the version suffix of the executed jar, when pet was correctly
   * built.
   *
   ...
   * Since cs108pet uses semantic versioning, this returns a string in format:
   * MAJOR.MINOR.FIX
   *
