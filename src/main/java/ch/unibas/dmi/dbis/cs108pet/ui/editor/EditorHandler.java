...
import ch.unibas.dmi.dbis.cs108pet.analysis.AssessmentManager;
import ch.unibas.dmi.dbis.cs108pet.analysis.Filter;
import ch.unibas.dmi.dbis.cs108pet.analysis.Filterable;
...
public class EditorHandler implements EventHandler<CUDEvent>, FilterActionHandler, Filterable {
  ...
  public void openCourse() {
    ...
    fc.getExtensionFilters().add(CS108PETFile.Type.COURSE.getExtensionFilter());
