...
import ch.unibas.dmi.dbis.cs108pet.data.Requirement.Type;
 ...
 * presentations. Given more time, it would potentially be nicer to add a separate UI view for cs108-pet but why reinvent
 * the wheel
 *
