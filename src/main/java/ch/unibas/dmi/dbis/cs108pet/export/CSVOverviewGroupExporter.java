package ch.unibas.dmi.dbis.cs108pet.export;
...
public class CSVOverviewGroupExporter {
  ...
  private String buildLongOverviewTable() {
    ...
    groups.forEach(group -> {
      ...
      catalogue.getMilestones().forEach(ms -> {
        sb.append(SEPARATOR);
        sb.append(ch.unibas.dmi.dbis.cs108pet.common.StringUtils.prettyPrint(groupAnalyser.getSumFor(groupAnalyser.getProgressSummaryFor(ms))));
      });
      
      // [Almost] Last column: Total
      sb.append(SEPARATOR);
      sb.append(ch.unibas.dmi.dbis.cs108pet.common.StringUtils.prettyPrint(groupAnalyser.getSum()));
      ...
      if (hasGradeForumla()) {
        ...
        sb.append(ch.unibas.dmi.dbis.cs108pet.common.StringUtils.prettyPrint(grade));
      }
