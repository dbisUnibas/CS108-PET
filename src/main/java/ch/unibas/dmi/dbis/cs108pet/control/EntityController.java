package ch.unibas.dmi.dbis.cs108pet.control;

import ch.unibas.dmi.dbis.cs108pet.analysis.CatalogueAnalyser;
import ch.unibas.dmi.dbis.cs108pet.analysis.GroupAnalyser;
import ch.unibas.dmi.dbis.cs108pet.common.EntityAlreadyOpenException;
import ch.unibas.dmi.dbis.cs108pet.common.MissingEntityException;
import ch.unibas.dmi.dbis.cs108pet.common.Version;
import ch.unibas.dmi.dbis.cs108pet.data.*;
import ch.unibas.dmi.dbis.cs108pet.session.SessionManager;
import ch.unibas.dmi.dbis.cs108pet.session.SessionStorage;
 ...
 * <ul>
 * <li>{@link ch.unibas.dmi.dbis.cs108pet.analysis.CatalogueAnalyser} for analyses of the {@link
 * ch.unibas.dmi.dbis.cs108pet.data.Catalogue}</li>
 * <li>{@link ch.unibas.dmi.dbis.cs108pet.analysis.GroupAnalyser} for analyses of a {@link
 * ch.unibas.dmi.dbis.cs108pet.data.Group}</li>
 * <li>{@link ch.unibas.dmi.dbis.cs108pet.data.CourseManager} for managing the {@link
 * ch.unibas.dmi.dbis.cs108pet.data.Course}</li>
 * <li>{@link ch.unibas.dmi.dbis.cs108pet.data.EntityFactory} for the creation of new entities</li>
 * <li>{@link ch.unibas.dmi.dbis.cs108pet.storage.StorageManager} for IO operations</li>
 * </ul>
 *
 * @author loris.sauter
 */
