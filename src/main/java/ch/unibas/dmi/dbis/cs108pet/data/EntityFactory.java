...
import ch.unibas.dmi.dbis.cs108pet.ui.common.MandatoryFieldsMissingException;
...
public class EntityFactory {
   ...
   * <p>
   * The resulting requirement is of type {@link ch.unibas.dmi.dbis.cs108pet.data.Requirement.Type#REGULAR}
   *
   * @param name
   * @param excerpt
   * @param maxPoints
   ...
   * <p>
   * The resulting requirement is of type {@link ch.unibas.dmi.dbis.cs108pet.data.Requirement.Type#REGULAR} and is
   * non-binary.
   *
   * @param name
   * @param excerpt
   ...
   * <p>
   * THe resulting requirement is of type {@link ch.unibas.dmi.dbis.cs108pet.data.Requirement.Type#MALUS} and is binary.
   *
   * @param name
   * @param excerpt
   * @param maxPoints
   ...
   * <p>
   * THe resulting requirement is of type {@link ch.unibas.dmi.dbis.cs108pet.data.Requirement.Type#BONUS} and is binary.
   *
   * @param name
   * @param excerpt
   * @param maxPoints
