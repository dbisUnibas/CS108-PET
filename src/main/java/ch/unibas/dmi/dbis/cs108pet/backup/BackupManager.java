package ch.unibas.dmi.dbis.cs108pet.backup;
...
public class BackupManager {
  ...
  private Path getDefaultBackupLocation() {
    return Paths.get(System.getProperty("user.home"), SessionManager.APP_DIR, DEFAULT_BACKUP_DIRECTORY);
  }
  
  private Path getBackupDescriptionLocation() {
    return Paths.get(System.getProperty("user.home"), SessionManager.APP_DIR, BACKUP_DESCRIPTION);
  }
