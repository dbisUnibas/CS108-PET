...
import ch.unibas.dmi.dbis.cs108pet.backup.BackupManager;
...
import ch.unibas.dmi.dbis.cs108pet.ui.common.TitledScene;
import ch.unibas.dmi.dbis.cs108pet.ui.editor.EditorHandler;
import ch.unibas.dmi.dbis.cs108pet.ui.editor.EditorView;
import ch.unibas.dmi.dbis.cs108pet.ui.evaluator.EvaluatorHandler;
import ch.unibas.dmi.dbis.cs108pet.ui.evaluator.EvaluatorView;
...
public class MainScene extends TitledScene {
  ...
  public String getTitle() {
    ...
    return String.format("cs108-pet %s (%s)", mode, Version.getInstance().getVersion());
  }
