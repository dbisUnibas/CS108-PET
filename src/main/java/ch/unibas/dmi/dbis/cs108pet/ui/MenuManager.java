 ...
 * <p>
 * Each menu item has a userdata string which is in the form of <code>menu[.submenu].name.item</code>. E.g. the menu
 * item <i>Quit</i> under the menu <i>File</i> has the key <code>file.quit.item</code>
 *
 * @author loris.sauter
 */
