...
/**
 * Class to use for boolean fields and then depending on the value of the boolean either oldRender something or
 * something else.
 *
 * @author loris.sauter
 */
public class ConditionalField<E> extends ParametrizedField<E, Boolean> {
   ...
   * @param name
   * @param getter
   * @param defaultTrueRenderer  It is ensured, that the passed object to oldRender is TRUE. WILL BE ASSIGNED ON RUNTIME
   *                             with real value.
   * @param defaultFalseRenderer It is ensured, that the passed object to oldRender is FALSE. WILL BE ASSIGNED ON
   *                             RUNTIME with real value.
   */
