 ...
 * }</pre>
 * <p>
 * Since the attribute {@code name} of the class {@code Person} is an instance of {@code Name} on its own, one must
 * provide a {@code renderer}:
 * <pre>
...
public class Field<E, T> {
  ...
  public enum Type {
    ...
    PARAMETRIZED,
    /**
     * To indicate that the field represented by the {@link Field} with this type is a list and therefore cannot be
     * rendered.
     */
    LIST
  }
